...
# from footprint.main.models import CoreIncrementFeature, CoreEndStateFeature, \
#     VmtQuarterMileBufferFeature, VmtOneMileBufferFeature, VmtVariableBufferFeature, VmtFeature,\
#     WaterFeature, EnergyFeature, DbEntity, AgricultureFeature
...
class SandagScenarioFixture(ScenarioFixture):
    ...
    def default_db_entities(self):
        ...
        return super(SandagScenarioFixture, self).default_db_entities() + map(
